...
class MyTestCase(unittest.TestCase):
    ...
    def test_basic(self):
        """Test for when there are no blanks or duplicates and the function just adds a column"""
    ...
    def test_duplicates(self):
        """Test for when there are duplicate document and code description pairings"""
        # Makes a dataframe to use as test input and runs the function being tested.
        df = make_df([['30601', 'path\\file1.txt', 'apple'],
                      ['30602', 'path\\file2.txt', 'berry'],
                      ['30603', 'path\\file3.txt', 'pears'],
                      ['30604', 'path\\file2.txt', 'apple'],
                      ['30605', 'path\\file3.txt', 'pears'],
                      ['30606', 'path\\file2.txt', 'berry'],
                      ['30607', 'path\\file2.txt', 'berry']])
        df_topics = topics_sort_df(df)
