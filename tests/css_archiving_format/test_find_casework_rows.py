...
class MyTestCase(unittest.TestCase):
    ...
    def test_all_casework(self):
        ...
        find_casework_rows(md_df, 'test_data')
        ...
        # Tests the values in the delete log are correct.
        ...
        expected = [['zip', 'in_topic', 'in_text'],
                    ...
                    ['30601', 'Health', 'This is casework']]
        self.assertEqual(result, expected, "Problem with test for all casework, delete log")
    ...
    def test_case_phase(self):
        ...
        self.assertEqual(result, expected, "Problem with test for case phrase, delete log")
    ...
    def test_casework_keyword(self):
        ...
        expected = [['zip', 'in_topic', 'in_text'],
                    ...
                    ['casework', 'nan', 'nan']]
        self.assertEqual(result, expected, "Problem with test for casework keyword, delete log")
    ...
    def test_in_topic_exact(self):
        ...
        expected = [['zip', 'in_topic', 'in_text'],
                    ...
                    ['30604', 'Prison Case', 'note']]
        self.assertEqual(result, expected, "Problem with test for in_topic, exact match, delete log")
    ...
    def test_in_topic_partial(self):
        ...
        self.assertEqual(result, expected, "Problem with test for in_topic, partial match, delete log")
    ...
    def test_no_casework(self):
        ...
        # Tests that no delete log was made.
        result = os.path.exists(os.path.join('test_data', 'case_delete_log.csv'))
        self.assertEqual(result, False, "Problem with test for no casework, delete log")
