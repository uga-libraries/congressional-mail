...
class MyTestCase(unittest.TestCase):
    ...
    def test_in_text(self):
        ...
        md_df = remove_casework(md_df)

        # Tests the values in the returned dataframe are correct.
        result = df_to_list(md_df)
        expected = [['zip', 'in_topic', 'in_text'], ['30605', '', 'This is not casework']]
    ...
    def test_in_topic_exact(self):
        ...
        # Tests the values in the returned dataframe are correct.
        result = df_to_list(md_df)
        expected = [['zip', 'in_topic', 'in_text'], ['30601', 'Keep', 'note']]
    ...
    def test_in_topic_partial(self):
        ...
        # Tests the values in the returned dataframe are correct.
        result = df_to_list(md_df)
        expected = [['zip', 'in_topic', 'in_text'], ['30600', 'Keep', '']]
        self.assertEqual(result, expected, "Problem with test for in_topic, partial match")
