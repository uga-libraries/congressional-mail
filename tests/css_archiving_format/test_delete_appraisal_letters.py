...
def make_df(rows):
    """Make a df with consistent columns for test input"""
    column_names = ['last', 'in_document_name_split', 'out_document_name_split', 'Appraisal_Category']
...
class MyTestCase(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        test_dirs = [os.path.join('test_data', 'delete_appraisal_letters', 'in_document_name_split'),
                     os.path.join('test_data', 'delete_appraisal_letters', 'out_document_name_split')]
    ...
    def test_in_document_name_split(self):
        """Test for deleting files in the in_document_name_split column"""
        # Makes a copy of the test data in the repo, since the script alters the data.
        output_directory = os.path.join('test_data', 'delete_appraisal_letters', 'in_document_name_split')
        ...
        appraisal_df = make_df([['Anderson', r'..\documents\BlobExport\objects\111111.txt',
        ...
        self.assertEqual(expected, result, "Problem with test for in_document_name_split, file deletion log")
        ...
        self.assertEqual(expected, result, "Problem with test for in_document_name_split, directory contents")

    def test_in_skip(self):
        """Test for deleting files in the in_document_name_split column, where some rows should be skipped"""
        # Makes a copy of the test data in the repo, since the script alters the data.
        output_directory = os.path.join('test_data', 'delete_appraisal_letters', 'in_document_name_split')
        shutil.copytree(os.path.join(output_directory, 'Name_Constituent_Mail_Export_copy'),
                        os.path.join(output_directory, 'Name_Constituent_Mail_Export'))
        ...
        # Makes variables needed as function input and runs the function being tested.
        input_directory = os.path.join(output_directory, 'Name_Constituent_Mail_Export')
        appraisal_df = make_df([['Abe', r'..\documents\BlobExport\objects\111111.txt', '', 'Academy_Application'],
                                ['Blue', r'..\documents\BlobExport\objects\222222.txt', '', 'Academy_Application'],
    ...
    def test_out_document_name_split(self):
        """Test for deleting files in the out_document_name_split column"""
        # Makes a copy of the test data in the repo, since the script alters the data.
        output_directory = os.path.join('test_data', 'delete_appraisal_letters', 'out_document_name_split')
        shutil.copytree(os.path.join(output_directory, 'Name_Constituent_Mail_Export_copy'),
                        os.path.join(output_directory, 'Name_Constituent_Mail_Export'))

        # Makes variables needed as function input and runs the function being tested.
        input_directory = os.path.join(output_directory, 'Name_Constituent_Mail_Export')
        appraisal_df = make_df([['Dudley', '', r'\\office-dc\dos\public\letter\111111.txt', 'Academy_Application'],
        ...
        self.assertEqual(expected, result, "Problem with test for out_document_name_split, file deletion log")

        # Tests the contents of the input_directory, that all files that should be deleted are gone.
        result = files_in_dir(input_directory)
        expected = ['form_a.txt', 'test.txt', '222222.txt']
        self.assertEqual(expected, result, "Problem with test for out_document_name_split, directory contents")

    def test_out_skip(self):
        """Test for deleting files in the out_document_name_split column, where some rows should be skipped"""
        # Makes a copy of the test data in the repo, since the script alters the data.
        output_directory = os.path.join('test_data', 'delete_appraisal_letters', 'out_document_name_split')
        shutil.copytree(os.path.join(output_directory, 'Name_Constituent_Mail_Export_copy'),
                        os.path.join(output_directory, 'Name_Constituent_Mail_Export'))
        ...
        # Makes variables needed as function input and runs the function being tested.
        input_directory = os.path.join(output_directory, 'Name_Constituent_Mail_Export')
        appraisal_df = make_df([['Anderson', '', r'\\office-dc\dos\public\form\form_a.txt', 'Casework'],
    ...
    def test_error_new(self):
        ...
        input_directory = os.path.join(output_directory, 'Name_Constituent_Mail_Export')
        appraisal_df = make_df([['Anderson', r'objects\111111.txt', r'form\test.txt', 'Academy_Application'],
    ...
    def test_filenotfounderror_in(self):
        """Test for when files in in_document_name_split are not present and cannot be deleted"""
        # Makes variables needed as function input and runs the function being tested.
    ...
    def test_filenotfounderror_out(self):
        """Test for when files in out_document_name_split are not present and cannot be deleted"""
        # Makes variables needed as function input and runs the function being tested.
        output_directory = os.path.join('test_data', 'delete_appraisal_letters', 'filenotfounderror')
        input_directory = os.path.join(output_directory, 'Name_Constituent_Mail_Export')
        appraisal_df = make_df([['Anderson', '', r'..\documents\BlobExport\objects\111111.txt', 'Academy_Application'],
                                ['Evans', '', r'..\documents\BlobExport\indivletters\500.txt', 'Casework']])
        delete_appraisal_letters(input_directory, output_directory, appraisal_df)
