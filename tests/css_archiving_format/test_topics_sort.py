...
class MyTestCase(unittest.TestCase):
    ...
    def test_doc_in(self):
        ...
        rows = [['ag', '..\\documents\\BlobExport\\objects\\file1.txt^..\\documents\\BlobExport\\objects\\file3.txt',
                ...
                ['farm', '..\\documents\\BlobExport\\objects\\file3.txt', np.nan, np.nan,
                 '..\\documents\\BlobExport\\objects\\file3.txt', np.nan]]
    ...
    def test_doc_out(self):
        ...
        expected = [['city', 'state', 'zip', 'country', 'in_id', 'in_type', 'in_method', 'in_date', 'in_topic',
                    ...
                    ['*', '*', '*', '*', '*', '*', '*', '*', 'BLANK', 'BLANK', 'no_path_provided', '*', '*', '*', '*',
                     'ag', '..\\documents\\BlobExport\\responses\\a1.txt^..\\documents\\BlobExport\\responses\\a2.txt',
                     '..\\documents\\BlobExport\\responses\\a1.txt', 'True'],
                    ['*', '*', '*', '*', '*', '*', '*', '*', 'BLANK', 'BLANK', 'no_path_provided', '*', '*', '*', '*',
                     'ag', '..\\documents\\BlobExport\\responses\\a1.txt^..\\documents\\BlobExport\\responses\\a2.txt',
                     '..\\documents\\BlobExport\\responses\\a2.txt', 'True']]
    ...
    def test_restart(self):
        ...
        expected = [os.path.join(output_restart, 'correspondence_by_topic'),
                    ...
                    os.path.join(by_topic, 'ag', 'to_constituents'),
                    os.path.join(by_topic, 'ag', 'ag_metadata.csv'),
                    os.path.join(by_topic, 'ag', 'to_constituents', 'responses'),
                    os.path.join(by_topic, 'ag', 'to_constituents', 'responses', 'ag.txt'),
                    os.path.join(by_topic, 'a_b', 'from_constituents'),
                    os.path.join(by_topic, 'a_b', 'to_constituents'),
                    os.path.join(by_topic, 'a_b', 'a_b_metadata.csv'),
                    os.path.join(by_topic, 'a_b', 'from_constituents', 'objects'),
                    os.path.join(by_topic, 'a_b', 'from_constituents', 'objects', 'file1.txt'),
                    os.path.join(by_topic, 'a_b', 'from_constituents', 'objects', 'file2.txt'),
                    os.path.join(by_topic, 'a_b', 'to_constituents', 'responses'),
                    os.path.join(by_topic, 'a_b', 'to_constituents', 'responses', 'ag.txt'),
                    os.path.join(by_topic, 'farm_bill', 'from_constituents'),
                    os.path.join(by_topic, 'farm_bill', 'farm_bill_metadata.csv'),
                    os.path.join(by_topic, 'farm_bill', 'from_constituents', 'objects'),
                    os.path.join(by_topic, 'farm_bill', 'from_constituents', 'objects', 'file3.txt')]
