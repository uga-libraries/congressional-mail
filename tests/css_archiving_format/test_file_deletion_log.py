...
class MyTestCase(unittest.TestCase):
    ...
    def test_delete_two(self):
        ...
        expected = [['File', 'SizeKB', 'DateCreated', 'DateDeleted', 'MD5', 'Notes'],
                    [file_path_1, '0.0', '2025-02-17', today, '89D31DC38A6C7D68653F452A2F44AC3D', 'Academy_Application'],
                    [file_path_2, '1.2', '2025-02-17', today, '9452DF84756C849AE0ED9FE2A14948F5', 'Casework']]
