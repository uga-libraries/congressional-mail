    ...
    def test_all_present(self):
        ...
        md_df = pd.DataFrame([['1', '2', '3', '4', '5', '6', '7', '8', '9',
                             ...
                             columns=['record_type_x', 'person_id_x', 'address_id_x', 'address_type', 'primary_flag',
                                      ...
                                      'record_type_y', 'communication_id', 'workflow_id', 'workflow_person_id',
                                      'communication_type', 'user_id', 'approved_by', 'status', 'date_in', 'date_out',
                                      'reminder_date', 'update_date', 'response_type', 'address_id_y', 'email_address',
        ...
        expected = [['13', '14', '15', '18', '31', '33', '34', '35', '36', '37', '38', '39',
                     '44', '49', '50', '51', '52', '53']]
