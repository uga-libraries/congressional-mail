...
class MyTestCase(unittest.TestCase):
    ...
    def test_duplicates(self):
        """Test for when there are rows with the same group_name and communication_document_name"""
        # Makes a dataframe to use as test input and runs the function being tested.
        df = make_df([['apple', '30601', 'path\\file1.txt'],
                      ['berry', '30602', 'path\\file2.txt'],
                      ['apple', '30603', 'path\\file1.txt'],
                      ['berry', '30604', 'path\\file2.txt'],
                      ['berry', '30605', 'path\\file5.txt'],
                      ['pears', '30606', 'path\\file6.txt'],
                      ['berry', '30607', 'path\\file2.txt'],])
        df_topics = topics_sort_df(df)
