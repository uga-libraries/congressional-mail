...
class MyTestCase(unittest.TestCase):
    ...
    def test_all_correct(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent'],
                    ['city', 'True', '0', '0.0'],
                    ['state_code', 'True', '0', '0.0'],
                    ['zip_code', 'True', '0', '0.0'],
                    ['country', 'True', '0', '0.0'],
                    ['communication_type', 'True', '0', '0.0'],
                    ['approved_by', 'True', '0', '0.0'],
                    ['status', 'True', '0', '0.0'],
                    ['date_in', 'True', '0', '0.0'],
                    ['date_out', 'True', '0', '0.0'],
                    ['reminder_date', 'True', '0', '0.0'],
                    ['update_date', 'True', '0', '0.0'],
                    ['response_type', 'True', '0', '0.0'],
                    ['group_name', 'True', '0', '0.0'],
                    ['document_type', 'True', '0', '0.0'],
                    ['communication_document_name', 'True', '0', '0.0'],
                    ['communication_document_id', 'True', '0', '0.0'],
                    ['file_location', 'True', '0', '0.0'],
                    ['file_name', 'True', '0', '0.0']]
    ...
    def test_blank(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent'],
                    ['city', 'True', '2', '100.0'],
                    ['state_code', 'True', '2', '100.0'],
                    ['zip_code', 'True', '2', '100.0'],
                    ['country', 'True', '2', '100.0'],
                    ['communication_type', 'True', '2', '100.0'],
                    ['approved_by', 'True', '2', '100.0'],
                    ['status', 'True', '2', '100.0'],
                    ['date_in', 'True', '2', '100.0'],
                    ['date_out', 'True', '2', '100.0'],
                    ['reminder_date', 'True', '2', '100.0'],
                    ['update_date', 'True', '2', '100.0'],
                    ['response_type', 'True', '2', '100.0'],
                    ['group_name', 'True', '2', '100.0'],
                    ['document_type', 'True', '2', '100.0'],
                    ['communication_document_name', 'True', '2', '100.0'],
                    ['communication_document_id', 'True', '2', '100.0'],
                    ['file_location', 'True', '2', '100.0'],
                    ['file_name', 'True', '2', '100.0']]
    ...
    def test_blank_partial(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent'],
                    ['city', 'True', '1', '33.33'],
                    ['state_code', 'True', '1', '33.33'],
                    ['zip_code', 'True', '1', '33.33'],
                    ['country', 'True', '2', '66.67'],
                    ['communication_type', 'True', '2', '66.67'],
                    ['approved_by', 'True', '2', '66.67'],
                    ['status', 'True', '2', '66.67'],
                    ['date_in', 'True', '1', '33.33'],
                    ['date_out', 'True', '1', '33.33'],
                    ['reminder_date', 'True', '1', '33.33'],
                    ['update_date', 'True', '1', '33.33'],
                    ['response_type', 'True', '2', '66.67'],
                    ['group_name', 'True', '2', '66.67'],
                    ['document_type', 'True', '2', '66.67'],
                    ['communication_document_name', 'True', '2', '66.67'],
                    ['communication_document_id', 'True', '1', '33.33'],
                    ['file_location', 'True', '1', '33.33'],
                    ['file_name', 'True', '1', '33.33']]
    ...
    def test_columns_extra(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent'],
                    ...
                    ['date_out', 'True', '0', '0.0'],
                    ['document_type', 'True', '0', '0.0'],
                    ['extra_beginning', 'Error: unexpected column', '0', '0.0'],
                    ['extra_end', 'Error: unexpected column', '0', '0.0'],
                    ['extra_middle', 'Error: unexpected column', '0', '0.0'],
                    ['file_location', 'True', '0', '0.0'],
                    ['file_name', 'True', '0', '0.0'],
                    ['group_name', 'True', '0', '0.0'],
                    ['reminder_date', 'True', '0', '0.0'],
    ...
    def test_columns_missing(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent'],
                    ['city', 'False', 'nan', 'nan'],
                    ['state_code', 'False', 'nan', 'nan'],
                    ['zip_code', 'False', 'nan', 'nan'],
                    ['country', 'False', 'nan', 'nan'],
                    ['communication_type', 'False', 'nan', 'nan'],
                    ['approved_by', 'False', 'nan', 'nan'],
                    ['status', 'False', 'nan', 'nan'],
                    ['date_in', 'True', '0.0', '0.0'],
                    ['date_out', 'True', '0.0', '0.0'],
                    ['reminder_date', 'True', '0.0', '0.0'],
                    ['update_date', 'True', '0.0', '0.0'],
                    ['response_type', 'False', 'nan', 'nan'],
                    ['group_name', 'False', 'nan', 'nan'],
                    ['document_type', 'False', 'nan', 'nan'],
                    ['communication_document_name', 'False', 'nan', 'nan'],
                    ['communication_document_id', 'False', 'nan', 'nan'],
                    ['file_location', 'False', 'nan', 'nan'],
                    ['file_name', 'False', 'nan', 'nan']]
    ...
    def test_columns_missing_dates(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent'],
                    ...
                    ['communication_type', 'True', '0.0', '0.0'],
                    ['approved_by', 'True', '0.0', '0.0'],
                    ['status', 'True', '0.0', '0.0'],
                    ['date_in', 'False', 'nan', 'nan'],
                    ['date_out', 'False', 'nan', 'nan'],
                    ['reminder_date', 'False', 'nan', 'nan'],
                    ['update_date', 'False', 'nan', 'nan'],
                    ['response_type', 'True', '0.0', '0.0'],
                    ['group_name', 'True', '0.0', '0.0'],
                    ['document_type', 'True', '0.0', '0.0'],
                    ['communication_document_name', 'True', '0.0', '0.0'],
                    ['communication_document_id', 'True', '0.0', '0.0'],
                    ['file_location', 'True', '0.0', '0.0'],
                    ['file_name', 'True', '0.0', '0.0']]
