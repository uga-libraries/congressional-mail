...
class MyTestCase(unittest.TestCase):
    ...
    def test_blank(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent', 'Formatting_Errors'],
                    ...
                    ['state_code', 'True', '2', '100.0', 'column_blank'],
                    ...
                    ['reminder_date', 'True', '2', '100.0', 'column_blank'],
                    ...
                    ['communication_document_name', 'True', '2', '100.0', 'column_blank'],
    ...
    def test_columns_missing(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent', 'Formatting_Errors'],
                    ...
                    ['state_code', 'False', 'BLANK', 'BLANK', 'column_missing'],
                    ['zip_code', 'False', 'BLANK', 'BLANK', 'column_missing'],
                    ['country', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['communication_type', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['approved_by', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['status', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ...
                    ['group_name', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['document_type', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['communication_document_name', 'False', 'BLANK', 'BLANK', 'column_missing'],
                    ['communication_document_id', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['file_location', 'False', 'BLANK', 'BLANK', 'uncheckable'],
                    ['file_name', 'False', 'BLANK', 'BLANK', 'uncheckable']]
    ...
    def test_columns_missing_dates(self):
        ...
        expected = [['Column_Name', 'Present', 'Blank_Count', 'Blank_Percent', 'Formatting_Errors'],
                    ...
                    ['reminder_date', 'False', 'BLANK', 'BLANK', 'column_missing'],
